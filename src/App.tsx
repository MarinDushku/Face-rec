...
function App() {
  ...
  const [currentStreamer, setCurrentStreamer] = useState<VideoStreamer | null>(null)
  const [error, setError] = useState<VideoError | null>(null)
  const [key, setKey] = useState(0) // Force remount of VideoFeed

  const handleStreamReady = useCallback((_videoElement: HTMLVideoElement, streamer: VideoStreamer) => {
